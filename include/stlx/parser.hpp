 ...
 */
 ...
 #define STRING_(x) \
         ...
         using x = stlx::parse::string<decltype(_::x), _::x>;
 
 #define STRING(_name, _value) \
         namespace _ { char _name[] = _value; } \
         using _name = stlx::parse::string<decltype(_::_name), _::_name>;
 
 #define CHARACTER_(_name, _value) \
         using _name = stlx::parse::character<_value>
 
 #define CHARACTERS_(_name, _first, _last) \
         using _name = stlx::parse::characters<_first, _last>
 
 #define REGEX(_name, _value) \
         namespace _ { char _name[] = _value; } \
         using _name = stlx::parse::regex<decltype(_::_name), _::_name>;
