 ...
 */
 ...
 public:
   ...
   rule_base(_child_ts &&...oChildRules)
       : super_t{std::forward<_child_ts>(oChildRules)...}, _parent() {}
 ...
 public:
   ...
   static bool parse(context<iterator_type> &ctx, iterator_type &begin,
              iterator_type &end)  {
     return decl_type::parse(ctx, begin, end);
   }
 };
 ...
 public:
   ...
   template <typename... _child_rule_ts>
   explicit not_(_child_rule_ts &&...oChildRules)
       : _super_t(std::forward<_child_rule_ts>(oChildRules)...) {}
 ...
 public:
   ...
   template <typename... _child_rule_ts>
   explicit and_(_child_rule_ts &&...oChildRules)
       : _super_t(std::forward<_child_rule_ts>(oChildRules)...) {}
 };
 template <typename Iterator, typename _head_t, typename... _tail_ts>
 ...
 public:
   ...
   template <typename... _child_rule_ts>
   explicit or_(_child_rule_ts &&...oChildRules)
       : _super_t(std::forward<_child_rule_ts>(oChildRules)...) {}
 ...
 public:
   ...
   template <typename... _child_rule_ts>
   explicit one_or_more_(_child_rule_ts &&...oChildRules)
       : _super_t(std::forward<_child_rule_ts>(oChildRules)...),
         _match_count(0) {}
   ...
   [[nodiscard]] size_t size() const override { return _match_count; }
 ...
 public:
   ...
   template <typename... _child_rule_ts>
   explicit zero_or_more_(_child_rule_ts &&...oChildRules)
       : _super_t(std::forward<_child_rule_ts>(oChildRules)...),
         _match_count(0) {}
 ...
 public:
   ...
   template <typename... _child_rule_ts>
   explicit zero_or_one_(_child_rule_ts &&...oChildRules)
       : _super_t(std::forward<_child_rule_ts>(oChildRules)...),
         _match_count(0) {}
 ...
 public:
   ...
   std::string_view get_text() const override {
     return std::string_view(&_matched, 1);
   }
 };
 ...
 public:
   ...
   static bool parse(context<iterator_type> &ctx, iterator_type &begin,
     ...
     if (begin == end) {
       ctx.parse_errors.emplace_back(
           std::make_shared<parse_error<iterator_type>>(
               this->type(), backup, "Expected character in range", "EOF"));
       begin = backup;
       return false;
     }
 ...
 public:
   ...
   stataic bool parse(context<iterator_type> &ctx, iterator_type &begin,
              iterator_type &end) {
